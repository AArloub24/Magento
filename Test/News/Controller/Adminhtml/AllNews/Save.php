...
namespace Test\News\Controller\Adminhtml\Allnews;

use Magento\Backend\App\Action;
use Test\News\Model\Allnews;
...
class Save extends \Magento\Backend\App\Action
{
    ...
    /**
     * @var \Test\News\Model\AllnewsFactory
     */
    private $allnewsFactory;

    /**
     * @var \Test\News\Api\AllnewsRepositoryInterface
     */
     ...
     * @param \Test\News\Model\AllnewsFactory $allnewsFactory
     * @param \Test\News\Api\AllnewsRepositoryInterface $allnewsRepository
     */
    public function __construct(
        Action\Context $context,
        DataPersistorInterface $dataPersistor,
        \Test\News\Model\AllnewsFactory $allnewsFactory = null,
        \Test\News\Api\AllnewsRepositoryInterface $allnewsRepository = null
    ) {
        $this->dataPersistor = $dataPersistor;
        $this->allnewsFactory = $allnewsFactory
            ?: \Magento\Framework\App\ObjectManager::getInstance()->get(\Test\News\Model\AllnewsFactory::class);
        $this->allnewsRepository = $allnewsRepository
            ?: \Magento\Framework\App\ObjectManager::getInstance()->get(\Test\News\Api\AllnewsRepositoryInterface::class);
	...
	{
		return $this->_authorization->isAllowed('Test_News::save');
	}
    ...
    public function execute()
    {
        ...
        if ($data) {
            ...
            /** @var \Test\News\Model\Allnews $model */
